...
public class Player extends Element implements KeyBehaviour, Collidable, TimedBehaviour {
	...
	public Player(){
		super("/resources/textures/player1.png");
	...
	public void handleKeyPresses(Set<String> set) {
		if (set.contains("UP") && !recentlyFired) {
			shoot();
